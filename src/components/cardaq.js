                        ...
                        <div className="flip-card__container">
                            <div className="card-front">
                                <div className="card-front__tp card-front__tp--city">
                                    ...
                                    viewBox="0 0 60 60" style="enable-background:new 0 0 60 60;" xmlSpace="preserve" className="card-front__icon">
                               <g>
                            ...
                            <div className="card-back">
                                <div className="video__container" autoplay muted loop>
                                   <span className="video__media">
